...
class Atri:
	...
	def experience(self, new_state):
		...
		global default_state
		self._experience = Flex(new_state, default_state["experience"])
	...
	@property
	def action(self):
		self._getter_access_tracker["action"] = {}
		return self._action
	@action.setter
	def action(self, new_state):
		self._setter_access_tracker["action"] = {}
		global default_state
		self._action = Flex(new_state, default_state["action"])
